...
//make 2 tiered or equivalent complexity hash table LOL
//make merge sort algorithm

//use hashtable to create leaderboard saved in a txt file/csv
//use merge sort to display leaderboard
