...
//can use loops, i + x, x = -1, 0, +1, courtesy of duck debugger:
//for (int i = 0; i < height; i++) {
//    for (int j = 0; j < width; j++) {
...
//                    // Accumulate color values and count pixels
//                }
//            }
//        }
//    }
//}
    ...
    //in above functions, when using image[i][j], each element is accessed and altered, eg 0x3[bbggrr] to 0x3[bBggRR]
    return;
}
