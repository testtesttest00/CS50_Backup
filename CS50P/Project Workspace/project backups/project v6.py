...
#                pass
    ...
    def tttcalculator(self, current):
        print("testtest")
        print(current)
        if (self.player==current[1]==current[2] or self.player==current[3]==current[6] or self.player==current[4]==current[8]) and self.ai != current[0]:
            return "a1"
        elif (self.player==current[0]==current[2] or self.player==current[4]==current[7]) and self.ai != current[1]:
            return "a2"
        elif (self.player==current[0]==current[1] or self.player==current[4]==current[6] or self.player==current[5]==current[8]) and self.ai != current[2]:
            return "a3"
        elif (self.player==current[4]==current[5] or self.player==current[0]==current[6]) and self.ai != current[3]:
            return "b1"
        elif (self.player==current[3]==current[5] or self.player==current[1]==current[7] or self.player==current[0]==current[8] or self.player==current[2]==current[6]) and self.ai != current[4]:
            return "b2"
        elif (self.player==current[3]==current[4] or self.player==current[2]==current[8]) and self.ai != current[5]:
            return "b3"
        elif (self.player==current[7]==current[8] or self.player==current[0]==current[3] or self.player==current[2]==current[4]) and self.ai != current[6]:
            return "c1"
        elif (self.player==current[6]==current[8] or self.player==current[1]==current[4]) and self.ai != current[7]:
            return "c2"
        elif (self.player==current[6]==current[7] or self.player==current[2]==current[5] or self.player==current[0]==current[4]) and self.ai != current[8]:
            return "c3"
        elif (self.ai==current[1]==current[2] or self.ai==current[3]==current[6] or self.ai==current[4]==current[8]) and self.ai != current[0]:
            return "a1"
        elif (self.ai==current[0]==current[2] or self.ai==current[4]==current[7]) and self.ai != current[1]:
            return "a2"
        elif (self.ai==current[0]==current[1] or self.ai==current[4]==current[6] or self.ai==current[5]==current[8]) and self.ai != current[2]:
            return "a3"
        elif (self.ai==current[4]==current[5] or self.ai==current[0]==current[6]) and self.ai != current[3]:
            return "b1"
        elif (self.ai==current[3]==current[5] or self.ai==current[1]==current[7] or self.ai==current[0]==current[8] or self.ai==current[2]==current[6]) and self.ai != current[4]:
            return "b2"
        elif (self.ai==current[3]==current[4] or self.ai==current[2]==current[8]) and self.ai != current[5]:
            return "b3"
        elif (self.ai==current[7]==current[8] or self.ai==current[0]==current[3] or self.ai==current[2]==current[4]) and self.ai != current[6]:
            return "c1"
        elif (self.ai==current[6]==current[8] or self.ai==current[1]==current[4]) and self.ai != current[7]:
            return "c2"
        elif (self.ai==current[6]==current[7] or self.ai==current[2]==current[5] or self.ai==current[0]==current[4]) and self.ai != current[8]:
            return "c3"
        else:
            print("wtest")
            if self.method1(current):
                print("a")
                return self.method1(current)
            elif self.method2():
                print("b")
                return self.method2()
            else:
